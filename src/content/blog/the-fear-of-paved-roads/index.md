...
<div style="display: flex; gap: 15px; flex-wrap: wrap; justify-content: center;">
  <figure style="margin: 0; text-align: center; flex: 1; max-width: 400px; min-width: 200px;">
    <img src="/images/thailand/img_7098.webp" alt="Classic Lanna Kingdom gravel" style="width: 100%;">
    <figcaption style="margin-top: 8px; font-style: italic; color: #666; font-size: 14px;">Classic Lanna Kingdom gravel</figcaption>
  </figure>
  <figure style="margin: 0; text-align: center; flex: 1; max-width: 400px; min-width: 200px;">
    <img src="/images/thailand/img_7100.webp" alt="Farmers in Mueang Kong" style="width: 100%;">
    <figcaption style="margin-top: 8px; font-style: italic; color: #666; font-size: 14px;">Farmers in Mueang Kong</figcaption>
  </figure>
</div>
...
<div style="display: flex; gap: 15px; flex-wrap: wrap; justify-content: center;">
  <figure style="margin: 0; text-align: center; flex: 1; max-width: 400px; min-width: 200px;">
    <img src="/images/thailand/img_7099.webp" alt="Downtown Wiang Haeng" style="width: 100%;">
  <figcaption style="margin-top: 8px; font-style: italic; color: #666; font-size: 14px;">Downtown Wiang Haeng</figcaption>
  </figure>
  <figure style="margin: 0; text-align: center; flex: 1; max-width: 400px; min-width: 200px;">
    <img src="/images/thailand/img_7097-1.webp" alt="Thai forest roads" style="width: 100%;">
  <figcaption style="margin-top: 8px; font-style: italic; color: #666; font-size: 14px;">Thai forest roads</figcaption>
  </figure>
</div>
<br>
<figure style="margin: 0; text-align: center;">
  <img src="/images/thailand/000015.webp" alt="Whiskey sodas with the locals" style="max-width: 600px; width: 100%;">
  <figcaption style="margin-top: 8px; font-style: italic; color: #666; font-size: 14px;">Whiskey sodas with the locals</figcaption>
</figure>
...
<figure style="margin: 0; text-align: center;">
  <img src="/images/thailand/000014.webp" alt="Sunrise from Doi Dam summit" style="max-width: 600px; width: 100%;">
  <figcaption style="margin-top: 8px; font-style: italic; color: #666; font-size: 14px;">Sunrise from Doi Dam summit</figcaption>
</figure>
...
<figure style="margin: 0; text-align: center;">
  <img src="/images/thailand/000012.webp" alt="Breakfast in Mueang Noi" style="max-width: 600px; width: 100%;">
  <figcaption style="margin-top: 8px; font-style: italic; color: #666; font-size: 14px;">Breakfast in Mueang Noi</figcaption>
</figure>
...
<div style="display: flex; gap: 15px; flex-wrap: wrap; justify-content: center;">
  <figure style="margin: 0; text-align: center; flex: 1; max-width: 400px; min-width: 200px;">
    <img src="/images/thailand/000001-2.webp" alt="Moonshine party with the builders" style="width: 100%;">
    <figcaption style="margin-top: 8px; font-style: italic; color: #666; font-size: 14px;">Moonshine party with the builders</figcaption>
  </figure>
  <figure style="margin: 0; text-align: center; flex: 1; max-width: 400px; min-width: 200px;">
    <img src="/images/thailand/img_7095-2.webp" alt="Camp for the night" style="width: 100%;">
    <figcaption style="margin-top: 8px; font-style: italic; color: #666; font-size: 14px;">Camp for the night</figcaption>
  </figure>
</div>
...
The route showed me a Thailand I never knew existed. Far from the party scene I'd dreaded, this was Thailand at its most generous and wild. For anyone looking for a remote 6 to 10 day adventure, have a look at the  [route](https://bikepacking.com/routes/the-lanna-kingdom/) or reach out to [Sam](https://www.instagram.com/adventuresbycycle) or [Nun](https://www.instagram.com/triple_cats_cycle).
